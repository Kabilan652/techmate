...
import { 
  User, Mail, Lock, Eye, EyeOff, ArrowRight, Check, Zap, ShieldCheck
} from 'lucide-react';
...
const SignupPage = () => {
  ...
  const handleChange = (e) => {
    ...
    // Clear API errors when the user starts typing again
    if (errors.api) {
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-8 bg-white order-2 lg:order-1">
        <div className="w-full max-w-md">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            {/* 🚨 API Error Display - This will show Supabase errors now! */}
            {errors.api && (
              <div className="p-3 bg-red-100 border border-red-400 text-red-700 rounded-lg text-sm text-center font-semibold">
                {errors.api}
              </div>
            )}
